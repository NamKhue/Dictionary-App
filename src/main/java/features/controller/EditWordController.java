...
public class EditWordController {
  @FXML public Label Confirm;
  @FXML public TextField editWord;
  
  /**
   * editProcess function.
   * @param inputWord input
   * @return word: is chosen to edit
   */
  public Word editProcess(Word inputWord) {
    ...
    int index = DictionaryV2.getInstance().binaryLookUp(editedWord, 0, DictionaryV2.getSize() - 1);
