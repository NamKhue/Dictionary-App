...
public final class GoogleTranslate { //Class marked as final since all methods are static
    ...
    public static final String GOOGLE_AUDIO_URL = "http://translate.google.com/translate_tts";
    ...
    public static String detectLanguage(String text) throws IOException {
        String urlText = generateTranslateURL("auto", "en", text);
    ...
    public static String translate(String sourceLanguage , String targetLanguage , String text) throws IOException, JSONException {
        String urlText = generateTranslateURL(sourceLanguage, targetLanguage, text);
